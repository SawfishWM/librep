...
/* from lisp.c */
extern repv rep_load_autoload(repv, repv, rep_bool);
...
extern repv Qvoid_function, Qvoid_value, Qbad_arg;
extern repv Qinvalid_read_syntax;
...
extern repv rep_bind_function (repv in_count, repv sym, repv new);
extern void rep_unbind_functions (repv count);
...
extern repv Fmake_closure (repv function);
...
extern repv Ffset(repv, repv);
extern repv Fmakunbound(repv);
extern repv Ffmakunbound(repv);
extern repv Flet(repv);
extern repv Fletstar(repv);
extern repv Fflet(repv);
extern repv Ffletstar(repv);
